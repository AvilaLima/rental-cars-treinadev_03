...
feature 'Admin view subsidiaries' do
  scenario 'successfully' do
    ...
    Car.create!(license_plate:'BMF-2790',color:'Bege',car_model: cm,mileage:'200000',subsidiary:sub)
    Car.create!(license_plate:'XDG-1090',color:'Verde',car_model: cm,mileage:'100000',subsidiary:sub)
